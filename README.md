...
- Clone the repository using `git@github.com:Alfred-KInyua/hello-react-front-end.git`
...
This project is [MIT](https://github.com/Alfred-KInyua/hello-rails-react/blob/hello-rails-front-end/MIT.md) licensed.
